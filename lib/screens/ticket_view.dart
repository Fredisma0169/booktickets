                ...
                children: [
                  Row(
                    children: [
                      ...
                      const ThickContainer(), //cercle Rond
                            ...
                            child: LayoutBuilder(
                              builder: (BuildContext context, BoxConstraints constraints) {
                                ...
                                return Flex(
                                  ...
                                  children: List.generate((constraints.constrainWidth()/9).floor(), (index) => const SizedBox(width: 3, height: 1, child: DecoratedBox(decoration: BoxDecoration(color: Colors.white
                                  ))
                                )),
                                );
                              },
